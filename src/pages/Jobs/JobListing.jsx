    ...
    return (
      <div className="h-screen flex items-center justify-center">
        <div className="text-black animate-spin">
          {/* Replace this with your custom spinner if you have one */}
          Loading...
        </div>
      </div>
    );
    ...
    <>
      ...
      {isFilterVisible && (
        <div className="flex flex-wrap px-2 py-4 gap-x-2 gap-y-1 justify-center shadow-md rounded-lg">
          ...
          <div className="flex justify-center ml-3 sm:pt-10">
            <button
      ...
      {/* Job Cards */}
      <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 py-10 container place-items-end px-10 sm:px-0 sm:py-10">
